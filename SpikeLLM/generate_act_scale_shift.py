...
def build_model_and_tokenizer(model_name, model_path=None):
...
def main():
    args = parse_args()
    model, tokenizer = build_model_and_tokenizer(args.model, args.model_path)
    ...
    if args.task==None:
        ...
        save_path = os.path.join(args.scales_output_path,f'{args.net}-{args.task}.pt')
    ...
    if args.task==None:
        ...
        save_path = os.path.join(args.shifts_output_path,f'{args.net}-{args.task}.pt')
    os.makedirs(os.path.dirname(save_path), exist_ok=True)
