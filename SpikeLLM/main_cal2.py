...
from spike_driven_quant.spike_omniquant import spike_omniquant, spike_cal
...
class OurArguments(TrainingArguments):
    ...
    lp_early_stopping: bool = False  #  False
    head_tuning: bool = False  #  False
    ...
    # Non-diff objective
    non_diff: bool = False  #  SQuAD  F1

    # Auto saving when interrupted
    save_on_interrupt: bool = False  #  False
