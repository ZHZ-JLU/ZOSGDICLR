...
def main():
    ...
    if args.resume_quant:
        ...
        if not args.load_cal:
            ...
            prefixed_key_values = torch.load(os.path.join(args.spike_model_path, 'prefixed_key_values.pth'), weights_only=False)
            activation_stat = None
        ...
        if args.epochs > 0 and not args.load_cal:
            ...
            if args.save_quant_dir:
                ...
                model.save_pretrained(args.save_quant_dir, safe_serialization=False)
